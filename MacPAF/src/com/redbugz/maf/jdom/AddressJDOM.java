...
public class AddressJDOM implements Address {
  ...
  public AddressJDOM(String addressLine1, String addressLine2, String city, String state, String postalCode,
  ...
  public void setPhoneNumbers(List phoneNumbers) {
	...
	if (phoneNumbers.size() > 3) {
	  throw new IllegalArgumentException("Only 3 phone numbers are allowed. Received " + phoneNumbers.size() +
										 " phone numbers.");
	}
	for (int i = 0; i < 3; i++) {
